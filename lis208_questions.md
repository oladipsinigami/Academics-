# LIS 208 Question Bank - Applications of Information Technology in Libraries
...
Type: Essay
Category: Easy
Text: Define a computer system and explain its fundamental data processing cycle (Input, Processing, Output, Storage).
Model Answer: A computer system is an electronic device that accepts raw data as input, processes it according to a set of instructions (program), stores the data or results, and produces meaningful information as output. The data processing cycle consists of four main stages: (1) Input: Collecting raw data using input devices like keyboards and scanners; (2) Processing: Transforming and manipulating data using the CPU; (3) Output: Presenting processed information in understandable forms via monitors or printers; and (4) Storage: Saving data on secondary storage media for future retrieval.
...
Type: Essay
Category: Easy
Text: Differentiate clearly between 'Data' and 'Information' in the context of library information systems.
Model Answer: Data consists of raw, unorganized facts, symbols, numbers, or observations that lack context (e.g., a list of uncataloged ISBN numbers or raw patron check-out figures). Information is data that has been processed, structured, organized, and interpreted within a specific context to make it meaningful and actionable for decision-making (e.g., a formatted library circulation report showing top borrowed books per month).
...
Type: Essay
Category: Easy
Text: Explain the three main components of a complete computer system: Hardware, Software, and Peopleware.
Model Answer: A computer system requires three essential components: (1) Hardware: The tangible, physical components of a computer system, such as the CPU, RAM, keyboard, monitor, and storage drives; (2) Software: The intangible set of programs, instructions, and operating rules that tell the hardware how to perform tasks (e.g., Operating Systems, Koha ILS); and (3) Peopleware: The human professionals and users who design, program, operate, and utilize the computer system (e.g., Systems Librarians, Database Administrators, and patrons).
...
Type: Essay
Category: Easy
Text: Highlight four key advantages of introducing computer technology and automation into library operations.
Model Answer: Four major advantages include: (1) High Speed & Efficiency: Rapid cataloging, searching, and instant check-in/check-out routines; (2) Accuracy & Error Reduction: Automated barcode/RFID scanning minimizes manual typographical errors; (3) Large Storage Capacity: Digital repositories store millions of e-books and journals in compact servers; and (4) Enhanced Remote Accessibility: 24/7 online access to library resources via Online Public Access Catalogs (OPAC).
...
Type: Essay
Category: Easy
Text: What is System Software? Give two examples of System Software used in library computer environments.
Model Answer: System Software consists of programs designed to manage, control, and coordinate the underlying computer hardware resources and provide a platform for application software to run. It operates continuously in the background. Examples include Operating Systems (such as Microsoft Windows, Linux, or macOS) and Utility Programs (such as disk defragmenters, antivirus software, and device drivers).
...
Type: Essay
Category: Easy
Text: Define Application Software and list two examples of specialized application software used in modern libraries.
Model Answer: Application Software comprises computer programs created to perform specific end-user tasks, workflows, or specialized activities. Unlike system software, application software directly serves user needs. Examples in libraries include Integrated Library Systems (ILS) like Koha or Virtua for library management, and Digital Repository Software like DSpace or Greenstone for archiving academic papers.
...
Type: Essay
Category: Easy
Text: Explain the function of Input Devices and name three common input devices used at a library circulation desk.
Model Answer: Input devices are hardware peripherals used to enter raw data, commands, and user instructions into a computer system for processing. At a library circulation desk, common input devices include: (1) Barcode/RFID Scanners to quickly capture patron IDs and book barcodes; (2) Keyboard to type patron details or query terms; and (3) Optical Mouse for navigating library management system menus.
...
Type: Essay
Category: Easy
Text: Explain the function of Output Devices and name three common output devices in a library setting.
Model Answer: Output devices are hardware peripherals that receive processed data from the computer's CPU and present it to the user in a human-readable or usable format (visual, audio, or printed). In a library, three common output devices are: (1) Computer Monitors/Displays for displaying search results and OPAC records; (2) Receipt/Laser Printers for printing checkout receipts and overdue notices; and (3) Audio Speakers for acoustic notifications and multimedia learning materials.
...
Type: Essay
Category: Easy
Text: What is an Online Public Access Catalog (OPAC) and how does it benefit library users?
Model Answer: An Online Public Access Catalog (OPAC) is a digitized, searchable database of all physical and digital holdings maintained by a library. It replaces traditional card catalogs and allows patrons to search for books, journals, and media by author, title, keyword, or subject from any connected computer or mobile device 24/7, providing real-time item availability status.
...
Type: Essay
Category: Easy
Text: Differentiate between Primary Storage (RAM) and Secondary Storage (Hard Disk Drives/SSDs).
Model Answer: Primary Storage (such as RAM) is high-speed, volatile memory directly accessed by the CPU to hold temporary data and active program instructions currently in use; its contents are lost when power is turned off. Secondary Storage (such as HDDs, SSDs, and optical disks) is non-volatile, permanent storage used to retain programs, database records, and digital library collections indefinitely even when the computer is powered off.
