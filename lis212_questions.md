# LIS 212 Question Bank - User Studies & Information Needs
...
Type: Essay
Category: Easy
Text: Define an 'Information User' and state three main categories of library information users.
Model Answer: An information user is any individual or group of individuals who seek, retrieve, evaluate, and utilize information to satisfy a specific need, solve a problem, or make an informed decision. Three major categories of library users include: (1) Academic Users: Students, lecturers, and researchers who require scholarly literature, textbooks, and research journals; (2) Professional Users: Lawyers, doctors, engineers, and executives who need specialized, highly accurate information for daily practice; and (3) Special Needs / Community Users: Rural populations, children, and patrons with physical or visual disabilities who require accessible library formats and services.
...
Type: Essay
Category: Easy
Text: Differentiate clearly between 'Information Need' and 'Information Seeking Behavior'.
Model Answer: An Information Need is a conscious or subconscious state of uncertainty, knowledge gap, or problem situation experienced by an individual that requires information to resolve. Information Seeking Behavior refers to the actual dynamic activities, actions, strategies, and search paths an individual undertakes to locate, retrieve, and obtain the necessary information from various formal and informal sources to satisfy that need.
...
Type: Essay
Category: Easy
Text: What is a 'User Study' in Library and Information Science, and why is it conducted?
Model Answer: A User Study is a systematic empirical research investigation conducted by librarians and information professionals to examine the information needs, seeking behaviors, usage patterns, and satisfaction levels of library patrons. It is conducted to evaluate existing library collections and services, identify unmet user needs, optimize resource allocation, and improve overall library service delivery.
...
Type: Essay
Category: Easy
Text: List and briefly explain four common data collection methods used in conducting library user studies.
Model Answer: Four common data collection methods are: (1) Questionnaires/Surveys: Using structured written sets of questions to collect quantitative and qualitative data from a large sample of users; (2) Interviews: Conducting face-to-face or virtual verbal discussions to gather in-depth insights into user experiences; (3) Direct Observation: Monitoring and recording patron interactions with library catalogs, shelves, and services in real-time; and (4) Focus Group Discussions: Moderating group conversations with selected user sub-groups to explore shared opinions and service feedback.
...
Type: Essay
Category: Easy
Text: Highlight four major barriers that patrons encounter during the information-seeking process.
Model Answer: Four major barriers include: (1) Technological Barriers: Limited internet connectivity, expensive database paywalls, or lack of digital access terminals; (2) Information Literacy Barriers: Low user skills in executing advanced database searches or evaluating source credibility; (3) Language Barriers: Resources published in languages not understood by the user; and (4) Physical / Environmental Barriers: Distance from libraries or inaccessible infrastructure for users with disabilities.
...
Type: Essay
Category: Easy
Text: Explain the concept of 'Information Literacy' and state its importance for academic library users.
Model Answer: Information Literacy is the set of integrated abilities encompassing the reflective discovery of information, the understanding of how information is produced and valued, and the ethical use of information in creating new knowledge. It is essential for academic users because it enables them to locate scholarly literature effectively, critically evaluate source credibility, synthesize complex arguments, and avoid academic dishonesty such as plagiarism.
...
Type: Essay
Category: Easy
Text: Define 'Gender-Responsive Library Services' and explain why gender consideration matters in information delivery.
Model Answer: Gender-Responsive Library Services refer to the deliberate planning, design, and implementation of library programs, information collections, and physical facilities that address the unique socio-cultural, economic, and security barriers faced by women and men. It matters because women often face specific constraints—such as domestic responsibilities, security concerns, or unequal digital literacy—requiring tailored outreach, flexible hours, and community-based information networks.
...
Type: Essay
Category: Easy
Text: Identify three types of adaptive technologies or services that libraries provide for patrons with special physical or visual needs.
Model Answer: Three adaptive services include: (1) Screen Reader Software & Braille Materials: Screen readers (e.g. NVDA, JAWS) and Braille books for visually impaired patrons; (2) Captioned Video & Sign Language Support: Accessible multimedia content for hearing-impaired patrons; and (3) Physical Accessibility Infrastructure: Wheelchair ramps, wide stack aisles, and height-adjustable computer terminals for physically challenged patrons.
...
Type: Essay
Category: Easy
Text: Compare the information needs of Academic Users (Students/Lecturers) versus Professional Users (Doctors/Lawyers).
Model Answer: Academic Users require comprehensive theoretical knowledge, historical context, peer-reviewed journal articles, and textbooks to support teaching, learning, and long-term academic research. Professional Users (such as doctors and lawyers) require immediate, highly specific, current, and legally or clinically authoritative information (such as recent case law, statutory acts, or clinical treatment protocols) to resolve real-time practice problems.
...
Type: Essay
Category: Easy
Text: Explain what 'Source Credibility' means and state two criteria used to evaluate information sources.
Model Answer: Source Credibility refers to the trustworthiness, reliability, accuracy, and authority of an information source. Two essential evaluation criteria are: (1) Authority / Publisher Expertise: Verifying the author's academic credentials, institutional affiliation, and whether the publisher is a recognized peer-reviewed body; and (2) Currency / Accuracy: Checking the publication date for timeliness and verifying whether claims are supported by empirical evidence and citations.
